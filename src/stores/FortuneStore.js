...
const getLoveFortuneData = () => [
  ...
  },
  {
    ...
    suggestion: "保持真实的自我，展现最好的一面。适时表达你的情感，不要因为害羞或顾虑而错失良机。"
  },
  // 新增签文
  {
    type: "月下情缘",
...
const getPastLifeFortuneData = () => [
  {
    type: "花前月下",
    poem: "前生相见花前月下，<br>今世重逢缘定三生。",
    interpretation: "你们前世曾是一对恋人，在花前月下立下誓言。今生重逢，是上天安排的再续前缘。即使初见，也会有似曾相识的感觉。",
    suggestion: "若已相遇，请珍惜这段缘分；若未相遇，静待命中注定的那个人到来。幸运物：古风发饰或配饰。"
  },
  {
    type: "琴瑟和鸣",
    poem: "一世琴缘一世情，<br>今生琴瑟奏华章。",
    interpretation: "前世你们是一对音乐伴侣，一个抚琴，一个吹箫，音律相和，心灵相通。今生相遇，将再次谱写美妙乐章。",
    suggestion: "关注与音乐相关的场合或活动，你的有缘人可能就在那里。或者尝试学习一种乐器，增加缘分相遇的机会。"
  },
  {
    type: "战场誓约",
    poem: "刀光剑影生死契，<br>乱世情深再续缘。",
    interpretation: "你们前世在战乱年代相遇，可能是战友或敌对阵营，经历生死考验。那段刻骨铭心的羁绊让你们今生再次相遇。",
    suggestion: "勇敢表达内心感受，不要让顾虑阻碍感情发展。幸运色：深红色。幸运方位：西北方。"
  },
  {
    type: "山水之约",
    poem: "前世山水间相逢，<br>今生犹记那山容。",
    interpretation: "你们前世曾在名山大川间结缘，或为游人，或为隐士。那份对自然的共同热爱让你们的灵魂产生共鸣，今生依然会被山水所吸引。",
    suggestion: "尝试亲近自然的活动，如徒步旅行或登山，可能会在不经意间遇见有缘人。幸运地点：有山有水的地方。"
  },
  {
    type: "师徒情缘",
    poem: "一朝为师终身牵，<br>今世再续师徒缘。",
    interpretation: "前世你们曾是师徒关系，教学相长，心灵相通。今生相遇，会感到一种难以言喻的熟悉与尊敬，或许会以类似的关系再续前缘。",
    suggestion: "关注学习和成长的场合，留意给予你指引或从你获取知识的人，可能正是命中注定的有缘人。"
  },
  // 新增前世姻缘签文
  {
    type: "书香之缘",
    poem: "前世书斋共研读，<br>今生墨香再相逢。",
    interpretation: "你们前世可能是志同道合的学者或文人，共同研究典籍，分享智慧。今生的你们依然会被知识和智慧所吸引，并有可能在书香氛围中重逢。",
    suggestion: "多去图书馆、书店或文化讲座，你的有缘人可能就在这些地方等着你。幸运物：一本有故事的旧书。"
  },
  {
    type: "商旅之缘",
    poem: "千里之途结商缘，<br>异国他乡情更深。",
    interpretation: "前世你们可能是在丝绸之路或海上贸易中相识的旅人或商人，共同经历了异国他乡的风景与艰辛。今生可能会在旅途或事业合作中重逢。",
    suggestion: "不要害怕远行，你的缘分可能在远方。工作中的出差或休闲旅行都可能是遇见良缘的契机。幸运物：来自远方的礼物。"
  },
  {
    type: "救赎之缘",
    poem: "前世一救恩情重，<br>今生再报救命恩。",
    interpretation: "你们前世可能有一段救赎的故事，其中一人挽救了另一人的生命或命运。这份深厚的恩情让你们的灵魂紧密相连，今生注定再会。",
    suggestion: "对他人保持善意和援助之心，或许在你帮助他人或接受他人帮助时，会遇到命中注定的人。幸运事：助人为乐。"
  },
  {
    type: "皇宫之缘",
    poem: "金銮殿前曾相望，<br>朱墙深处暗相思。",
    interpretation: "前世你们可能在皇宫贵族中有着复杂的关系，或是主仆，或是君臣，或是宫廷中的秘密恋人。今生你们可能仍会被权力、才华或地位所吸引。",
    suggestion: "关注社交圈中地位或才华出众的人，你们之间可能存在跨越时空的吸引力。幸运场合：正式的社交活动。"
  },
  {
    type: "邻里之缘",
    poem: "前世邻里共沐月，<br>今生街坊再叙旧。",
    interpretation: "你们前世可能是朝夕相处的邻居，共同分享生活的点滴，建立了深厚的情谊。今生可能会在熟悉的环境或日常生活中重逢。",
    suggestion: "不要忽视身边常见的人，你的缘分可能就在日常生活中。留意经常出现在你生活轨迹中的人，他们可能与你有前世约定。幸运地点：日常活动场所。"
  },
  {
    type: "江湖之缘",
    poem: "刀光剑影侠客行，<br>江湖路上再相逢。",
    interpretation: "前世你们可能是行走江湖的侠客，或敌或友，在刀光剑影中建立了特殊联系。今生你们可能在竞争或挑战中重新认识对方。",
    suggestion: "勇敢面对挑战，在竞争或困难中可能会遇到命中注定的人。武术、竞技或需要勇气的活动可能是良缘的触媒。幸运物：有历史的兵器或饰品。"
  },
  {
    type: "灵魂伴侣",
    poem: "两魂契合千年约，<br>灵犀一点不言中。",
    interpretation: "你们是真正的灵魂伴侣，前世可能以各种形式相遇，但灵魂始终相互吸引。今生重逢时，会有一种难以形容的心灵契合感。",
    suggestion: "相信直觉，当你遇到能够不言而喻的心灵沟通、一见如故的人时，不要轻易错过，这可能是你寻找了千百年的灵魂伴侣。幸运感觉：心灵共鸣。"
  },
  {
    type: "医患之缘",
    poem: "悬壶济世救苍生，<br>回眸一笑医者心。",
    interpretation: "前世你们可能是医者与病患，在生死关头建立了特殊的情感联系。那份生死相托的情谊穿越时空，今生你们可能会在关怀与被关怀中重逢。",
    suggestion: "当你生病或需要帮助时，对待你的人可能是前世有缘人。同样，当你帮助他人时，也可能遇见命中注定的人。幸运事：健康咨询或护理。"
  },
  {
    type: "艺术之缘",
    poem: "丹青妙手绘红颜，<br>今世画中人再现。",
    interpretation: "前世你们可能是艺术家与缪斯的关系，一个创作，一个启发。那份对美的共同追求让你们的灵魂紧密相连，今生依然会被艺术所吸引。",
    suggestion: "参与艺术活动，如绘画、雕塑、摄影或表演，这些场合可能会让你遇见灵魂深处熟悉的人。幸运物：手工艺品或艺术作品。"
  }
];
...
const getSpecialTurningFortuneData = () => [
  {
    type: "命运转折",
    poem: "柳暗花明春又至，<br>枯木逢春花自开。",
    interpretation: "近期你的姻缘运势将迎来重大转机。过去的不顺已是云烟，崭新的良缘即将到来。保持开放的心态，静待花开的时刻。",
    suggestion: "把握身边出现的新机会，尝试改变以往的社交模式。幸运色：嫩绿色。"
  },
  {
    type: "逆境重生",
    poem: "千磨万击还坚劲，<br>任尔东西南北风。",
    interpretation: "虽然感情上经历了一些困境，但这些考验使你更加坚强和明智。即将到来的是一段经得起风雨考验的真挚感情。",
    suggestion: "回顾过去的感情经历，提取宝贵经验。参加户外活动有助于提升运势。"
  },
  // 新增转机签文
  {
    type: "否极泰来",
    poem: "否极泰来逢吉运，<br>守得云开见月明。",
    interpretation: "感情上的低谷期即将过去，乌云散尽，月光如约而至。这是一个重要的转折点，之前的坚持和等待将得到回报。",
    suggestion: "保持积极的心态，不要因暂时的失意而放弃。多参加集体活动，扩大社交圈，良缘可能就在不经意间降临。幸运物：月亮形状的饰品。"
  },
  {
    type: "破茧成蝶",
    poem: "旧爱已成过往事，<br>新缘如蝶破茧来。",
    interpretation: "曾经的感情已经告一段落，就像蝴蝶必须挣脱蛹的束缚才能展翅高飞。现在的你已经准备好迎接全新的感情，这段新的缘分将更加美好。",
    suggestion: "尝试改变形象或生活方式，向过去的自己告别。适当的环境改变和心态调整将为新缘分创造条件。幸运行动：整理旧物，焕然一新。"
  },
  {
    type: "守得云开",
    poem: "守得云开见月明，<br>柳暗花明又一村。",
    interpretation: "等待是一种修行，而你的等待即将迎来回报。那个命中注定的人正朝你走来，当乌云散去，你们终将在月光下相见。",
    suggestion: "不必刻意寻找，保持平和的心态，继续做好自己。当时机成熟，缘分自然会到来。幸运习惯：夜晚散步，仰望星空。"
  },
  {
    type: "浴火重生",
    poem: "历经烈火淬真金，<br>浴火重生展新姿。",
    interpretation: "感情上的挫折和磨难如同烈火，锻造了更坚强的你。这次历练让你更加成熟，更懂得珍惜真感情，也为迎接真爱做好了准备。",
    suggestion: "正视过去的伤痛，接纳它们为生命的一部分。找回自信，你的新形象和气质将吸引更适合的人。幸运色：如火的橙红色。"
  },
  {
    type: "缘来如此",
    poem: "缘起缘灭皆有时，<br>不期而遇是缘分。",
    interpretation: "缘分来去有其规律，有些感情的结束是为了迎接更好的开始。近期你可能会在意想不到的场合遇见一个让你心动的人。",
    suggestion: "对新的相遇保持开放态度，不要被过去的经历所束缚。参加以前不曾尝试的活动，可能会有意外收获。幸运地点：从未去过的地方。"
  },
  {
    type: "因祸得福",
    poem: "塞翁失马焉知非福，<br>因祸得福缘自来。",
    interpretation: "看似不幸的感情变故可能是一种隐藏的祝福。当一扇门关上时，另一扇窗会打开，给你带来更适合的缘分和更多的可能性。",
    suggestion: "换个角度看待目前的状况，积极寻找其中的机遇。保持开放的心态，接纳命运的安排。幸运心态：感恩和接纳。"
  },
  {
    type: "柳暗花明",
    poem: "山穷水尽疑无路，<br>柳暗花明又一村。",
    interpretation: "当你感到爱情之路走到尽头时，转机往往就在眼前。生活总是充满惊喜，在你即将放弃的时刻，美好的缘分可能就在不远处等待。",
    suggestion: "继续前行，不要在困境中停滞不前。尝试改变思维方式，从新的角度看待感情问题。幸运时间：黄昏或黎明时分。"
  }
];
...
const getGeneralFortuneData = () => [
  ...
  },
  {
    ...
    interpretation: "近期应特别关注自己的健康状况。适当的运动和良好的生活习惯将为你带来充沛的精力和愉快的心情。",
  ...
  },
  {
    ...
    interpretation: "近期适合进行自我反思和提升。通过阅读、学习或与智者交流，你可以获得新的见解和智慧，提升自己的精神境界。",
...
const getNameFortuneData = () => [
  ...
  },
  {
    ...
    interpretation: "你的名字暗示你拥有独特的才华或思维方式。姓名学分析表明，这样的名字往往与不凡的创造力或特殊天赋相关联。",
...
const elementCompatibility = {
  '火-火': { level: 4, description: '激情似火，共同点多，但可能争夺主导权' },
  '火-土': { level: 2, description: '火被土所抑制，但土能给火稳定性' },
  '火-风': { level: 5, description: '风助火势，相互促进，活力满满' },
  '火-水': { level: 1, description: '基本元素相克，需要更多包容与理解' },
  '土-火': { level: 2, description: '土能控制火的过分活跃，但缺乏激情' },
  '土-土': { level: 4, description: '稳定可靠，但可能缺乏变化与激情' },
  '土-风': { level: 1, description: '基本元素相克，沟通方式差异大' },
  '土-水': { level: 5, description: '水滋养土地，相互促进，和谐共存' },
  '风-火': { level: 5, description: '风能助长火势，思想活跃，充满活力' },
  ...
  const getAvailableFortuneData = (categoryId) => {
    ...
    switch(categoryId) {
      ...
      case 'name':
        ...
        break;
      case 'daily':
        fortuneData = getGeneralFortuneData(); // 每日一签使用日常运势的签文
        break;
      case 'relationship':
        fortuneData = getCareerFortuneData(); // 人际关系暂时使用事业运势的签文（包含一些人际内容）
        break;
      case 'health':
        fortuneData = getGeneralFortuneData(); // 健康平安暂时使用日常运势的签文
        break;
      case 'zodiac':
      case 'destiny_ball':
  ...
  function drawFortune() {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        // 创建仪式音效
        try {
          const reveaAudio = new Audio('/sounds/reveal.mp3');
          reveaAudio.volume = 0.4;
          reveaAudio.play().catch(err => console.log('音效播放失败'));
        } catch (error) {
          console.log('音效创建失败');
        }
      }, 800); // 延长展示时间，增加期待感
